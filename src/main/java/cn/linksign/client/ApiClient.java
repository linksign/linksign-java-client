...
import cn.linksign.client.auth.OAuth;
...
public class ApiClient {
  ...
  private String basePath = "https://api.linksign.cn:443/v1";
  ...
  private DateFormat dateFormat;
   ...
   public ApiClient(String keyPath, String keyPassword) {
	...
	public static SSLContext getSSLContext() {
		...
		{		
			...
			sslConfig
					.keyStoreFile(
							keyPath)
					.keyStorePassword(keyPassword).keyPassword(keyPassword);
...
//					.trustStorePassword(trustPassword);
			...
			sslConfig.securityProtocol("TLSv1");
		}
  ...
  public ApiClient rebuildHttpClient() {
    ...
    //LinkSign SSL Config	
    conf.getProperties().put(HTTPSProperties.PROPERTY_HTTPS_PROPERTIES,   
            new HTTPSProperties(new MyHostnameVerifier(), getSSLContext())); 
